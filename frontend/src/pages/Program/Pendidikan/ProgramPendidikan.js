...
const ProgramPendidikan = () => {
  ...
  return (
    <div className="program-page">
      ...
      <p className="program-description">
  Program Pendidikan mendukung generasi penerus dengan beasiswa sekolah, bantuan alat tulis, serta pembangunan ruang belajar yang layak. Selain itu, program ini juga mengadakan kursus baca-tulis bagi orang dewasa, pelatihan keterampilan vokasi, dan pendampingan psikososial untuk anak-anak terdampak krisis.
</p>
